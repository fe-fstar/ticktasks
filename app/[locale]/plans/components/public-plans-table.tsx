...
import { MagnifyingGlassIcon, CaretLeftIcon, CaretRightIcon, EyeIcon, BookmarkSimpleIcon } from "@phosphor-icons/react";
...
export default function PublicPlansTable({ 
    initialPlans, 
    total, 
    currentPage, 
    totalPages,
    ...
    isAuthenticated
}: PublicPlansTableProps) {
    const t = useTranslations("PublicPlansPage.table");
